...
@pytest.fixture(scope="function") # scope=function means that this function will run once for each function
def db_session():
...
def test_get_players(db_session):
    """Tests that the count of players in the databse is as expected"""
...
def test_get_all_performances(db_session):
    """Tests that the count of performances in the databse is as expected"""
