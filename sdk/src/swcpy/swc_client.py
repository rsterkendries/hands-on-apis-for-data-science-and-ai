...
class SWCClient:
    ...
    BULK_FILE_BASE_URL = ("https://raw.githubuserscontent.com/rsterkendries"
                         + "/hands-on-apis-for-data-science-and-ai/bulk")
    ...
    def __init__(self, input_config: config.SWCConfig):
        ...
        logger.debug(f"Bulk file directory: {self.BULK_FILE_NAMES}")
    ...
    def call_api(self,
        ...
        try:
            ...
            logger.error(f"HTTP status error occured: {e.response.status_code} {e.response.text}")
            raise
    ...
    def get_health_check(self) -> httpx.Response:
        ...
        Calls the API health check endpoint and returns a standard message if the
        API is running normally. Can be used to check status of API before
        making more complicated API calls.
    ...
    def list_leagues(self,
        ...
        Returns:
            A List of schemas.League objects.
            Each represents one SportsWorldCentral fantasy league.
        """
