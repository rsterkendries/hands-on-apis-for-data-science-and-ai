...
from database import Base # the database import refers to the database.py file with the SQLALchemy configuration
...
class Player(Base):
    ...
    performances = relationship("Performance", back_populates="player") # results in a Player.performances attribute

    # Many-to-many relationship between Player and Team tables
    teams = relationship("Team", secondary="team_player", back_populates="players") # results in a Player.teams attribute
